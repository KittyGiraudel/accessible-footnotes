...
`react-a11y-footnotes` can be used in a [Docusaurus](https://docusaurus.io/) website like this one since content is authored in MDX which supports rendering React components.
