...
import { FootnoteRef, Footnotes } from "react-a11y-footnotes";

## What are footnotes

Footnotes are <FootnoteRef description={<>Footnotes do not actually have to be short, you can do whatever you want. Randall Munroe, in his <em>What If</em> books, has rather lengthy footnotes at times — and they are a delight.</>}>short</FootnoteRef> notes that add context to something you just read. You usually see them as a small reference in the text, with the full note shown at the end of the article or section.
